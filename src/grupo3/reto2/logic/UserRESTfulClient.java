...
public class UserRESTfulClient  {
    ...
    public <T> T findUsersByLogin_XML(GenericType<T> responseType, String login, String passwd) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findUserbyLogin&Passwrd/{0}/{1}", new Object[]{login, passwd}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findUsersByLogin_JSON(Class<T> responseType, String login, String passwd) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findUserbyLogin&Passwrd/{0}/{1}", new Object[]{login, passwd}));
